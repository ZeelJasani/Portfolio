...
// 🔍 HEADER LOGO: This component renders the logo in the header
// To change the header logo, edit: src/components/chanhdai-mark.tsx
...
export function SiteHeaderMark() {
  ...
  return isHome ? <ChanhDaiMarkMotion /> : <ZeelMark />;
}
