  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    for (const coordIndex of coordsIndexes) {
      ...
      if (alpha > 0) {
        ...
        particle.startColor = {
          r: particle.startColor.r + (newColor.r - particle.startColor.r) * particle.colorWeight,
          g: particle.startColor.g + (newColor.g - particle.startColor.g) * particle.colorWeight,
          b: particle.startColor.b + (newColor.b - particle.startColor.b) * particle.colorWeight,
        }
